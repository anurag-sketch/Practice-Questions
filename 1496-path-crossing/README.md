...
<pre style="position: relative;"><strong>Input:</strong> path = "NES"
...
<pre style="position: relative;"><strong>Input:</strong> path = "NESWW"
<strong>Output:</strong> true
<strong>Explanation:</strong> Notice that the path visits the origin twice.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
