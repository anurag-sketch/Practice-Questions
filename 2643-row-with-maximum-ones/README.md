...
<pre style="position: relative;"><strong>Input:</strong> mat = [[0,1],[1,0]]
...
<pre style="position: relative;"><strong>Input:</strong> mat = [[0,0,0],[0,1,1]]
...
<pre style="position: relative;"><strong>Input:</strong> mat = [[0,0],[1,1],[0,0]]
<strong>Output:</strong> [1,2]
