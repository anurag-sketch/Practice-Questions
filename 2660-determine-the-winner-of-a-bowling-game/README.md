...
<pre style="position: relative;"><strong>Input:</strong> player1 = [4,10,7,9], player2 = [6,5,2,3]
...
<pre style="position: relative;"><strong>Input:</strong> player1 = [3,5,7,6], player2 = [8,10,10,2]
...
<pre style="position: relative;"><strong>Input:</strong> player1 = [2,3], player2 = [4,1]
